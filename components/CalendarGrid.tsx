                                ...
                                {daysEvents.map(event => {
                                    ...
                                    return (
                                        <button 
                                            ...
                                            className={`
                                                w-full text-left rounded-md transition-all relative overflow-hidden pl-2
                                                ${!isWeekend ? 'p-1 hover:bg-theme-gold/20' : 'p-1.5 sm:p-2'}
                                        ...
                                        >
                                            ...
                                            {!isWeekend && (
                                                <div className="w-full text-center">
                                                    <span className="text-[9px] font-bold uppercase text-theme-gold leading-tight break-words line-clamp-2 block">
                                                        {event.teamName}
                                                    </span>
                                                </div>
                                            )}
